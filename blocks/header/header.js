...
export default async function decorate(block) {
  ...
  const hamburgerMenuContainer = (isMobile) => `<div class="hamburger-menu-container">
    <div class="hex hamburger-menu" id="hamburger-menu-wrapper${
      ...
      <input id="toggle-checker${isMobile ? '-mobile' : ''}" type="checkbox" class="toggle-checker">
  <label id="toggler-label" for="toggle-checker${isMobile ? '-mobile' : ''}">
